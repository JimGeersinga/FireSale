INSERT INTO address (id, street, house_number, postal_code, city, country, created,version)
VALUES (1, '', '', '', '', '', CURRENT_DATE(), 0),
       (2, '', '', '', '', '', CURRENT_DATE(), 0),
       (3, '', '', '', '', '', CURRENT_DATE(), 0),
       (4, '', '', '', '', '', CURRENT_DATE(), 0);

INSERT INTO user (id, email, password, display_name, first_name, last_name, date_of_birth, gender, address_id, role, is_locked, shipping_address_id, created, version)
...
INSERT INTO category (id, name, created,version)
